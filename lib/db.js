...
const SEED_PRODUCTS = [
  ['vip-rank', 'VIP Rank', 499, 'Get a VIP role in Discord and in-server, priority queue so you skip the wait during busy hours, priority support, and access to exclusive VIP-only channels.', 0, null],
  ...
  ['discord-unban-review', 'Discord + In-Game Unban Review', 500, 'Request a priority review of a Discord ban or an in-game ban.', 0, 'This guarantees a review, not a reversal.'],
];
