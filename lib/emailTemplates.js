...
<!DOCTYPE html>
<html>
  <body style="margin:0; padding:0; background-color:${BRAND_DARK}; font-family:Arial, Helvetica, sans-serif;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:${BRAND_DARK}; padding:32px 0;">
      <tr>
        <td align="center">
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#1a171d; border-radius:12px; overflow:hidden; border:1px solid #2d2a31;">
            ${
              bannerUrl
